...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        $collection->add_database_table('videotrack_progress', [
            ...
            'highesttime' => 'privacy:metadata:videotrack_progress:highesttime',
            'watchedsegments' => 'privacy:metadata:videotrack_progress:watchedsegments',
            'duration' => 'privacy:metadata:videotrack_progress:duration',
            'lastposition' => 'privacy:metadata:videotrack_progress:lastposition',
            'lastheartbeat' => 'privacy:metadata:videotrack_progress:lastheartbeat',
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        $sql = "SELECT cm.id AS cmid, v.name, vp.highestpercent, vp.highesttime, vp.watchedsegments,
                       vp.duration, vp.lastposition, vp.lastheartbeat, vp.iscompleted, vp.timecreated, vp.timemodified
                  FROM {context} c
                  JOIN {course_modules} cm ON cm.id = c.instanceid AND c.contextlevel = :contextlevel
                  JOIN {modules} m ON m.id = cm.module AND m.name = :modname
                  JOIN {videotrack} v ON v.id = cm.instance
        ...
        foreach ($records as $record) {
            ...
            $data = (object) [
                ...
                'highesttime' => $record->highesttime,
                'watchedsegments' => $record->watchedsegments,
                'duration' => $record->duration,
                'lastposition' => $record->lastposition,
                'lastheartbeat' => \core_privacy\local\request\transform::datetime($record->lastheartbeat),
